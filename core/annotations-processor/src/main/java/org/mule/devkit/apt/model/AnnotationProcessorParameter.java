...
public class AnnotationProcessorParameter extends AnnotationProcessorVariable<Method> implements Parameter {
    ...
    public AnnotationProcessorParameter(VariableElement element, Method parent, Types types, Elements elements, Trees trees) {
