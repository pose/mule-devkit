...
public class StringToDateTransformerGenerator extends AbstractMessageGenerator {
    ...
    private DefinedClass getTransformerClass(DevKitTypeElement typeElement) {
        ...
        return pkg._class(NamingContants.STRING_TO_DATE_TRANSFORMER_CLASS_NAME, AbstractTransformer.class, new Class<?>[]{DiscoverableTransformer.class, MuleContextAware.class});
    }
}