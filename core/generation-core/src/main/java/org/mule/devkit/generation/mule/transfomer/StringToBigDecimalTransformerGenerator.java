...
public class StringToBigDecimalTransformerGenerator extends AbstractMessageGenerator {
    ...
    public boolean shouldGenerate(Type type) {
        return type.hasProcessorMethodWithParameter(BigDecimal.class) ||
                type.hasConfigurableWithType(BigDecimal.class);
    }
    ...
    public void generate(Type type) {
        ...
        ctx().note("Generating String to BigDecimal transformer as " + transformerClass.fullName());
    ...
    private DefinedClass getTransformerClass(Type type) {
        ...
        return pkg._class(NamingConstants.STRING_TO_BIGDECIMAL_TRANSFORMER_CLASS_NAME, AbstractTransformer.class, new Class<?>[]{DiscoverableTransformer.class, MuleContextAware.class});
    }
}